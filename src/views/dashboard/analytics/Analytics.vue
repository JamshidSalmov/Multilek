  ...
  <section id="dashboard-analytics">
    <b-row class="match-height">
      <b-col
        lg="12"
      >
        <ecommerce-statistics :data="data2.statisticsItems" />
      </b-col>
      <!-- <b-col
        lg="6"
        md="12"
    ...
    <b-row class="match-height">
      ...
      <!-- Transaction Card -->
      <b-col lg="6">
        <ecommerce-transactions :data="data2.transactionData" />
      </b-col>
      <!--/ Transaction Card -->
    </b-row>
  ...
  created() {
    ...
    this.$http.get('/ecommerce/data')
      .then(response => {
        ...
        this.data2.congratulations.name = userData.full_name.split(' ')[0] || userData.first_name
      })
  },
  methods: {
    kFormatter,
