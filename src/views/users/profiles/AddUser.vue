    ...
    <b-form @submit.prevent="createUser">
      <b-card>
        <b-row>
          ...
          <!-- Password -->
          <b-col cols="12">
            <b-form-group label="Password" label-cols-md="4" label-for="Password">
              <b-form-input
                id="Password"
                type="password"
          ...
          <!-- User Name -->
          <b-col cols="12">
            <b-form-group label="Name" label-cols-md="4" label-for="Name">
              <b-form-input
                id="Name"
          ...
          <!-- User last name -->
          <b-col cols="12">
            <b-form-group label="Last name" label-cols-md="4" label-for="Last_name">
              <b-form-input
                id="Last_name"
          ...
          <!-- Brithday -->
          <b-col cols="12">
            <b-form-group label="Brithday" label-cols-md="4" label-for="Brithday">
              <b-form-input
                id="Brithday"
          ...
          <!-- Location -->
          <b-col cols="12">
            <b-form-group label="Location" label-cols-md="4" label-for="Location">
              <b-form-input
                id="Location"
          ...
          <!-- ill_history -->
          <b-col cols="12">
            <b-form-group label="Ill history" label-cols-md="4" label-for="ill_hestory">
              <b-form-input
                id="ill_hestory"
          ...
          <!-- finance_sum -->
          <b-col cols="12">
            <b-form-group label="finance_sum" label-cols-md="4" label-for="finance_sum">
              <b-form-input
                id="finance_sum"
          ...
          <b-col cols="12">
          <b-form-group label="is_active" label-cols-md="4" label-for="is_active">
            <b-form-checkbox
              id="is_active"
          ...
          <b-col cols="12">
            <b-form-group label="is_superuser" label-cols-md="4" label-for="is_superuser">
                <b-form-checkbox
                id="is_superuser"
          ...
          <b-col cols="12">
            <b-form-group label="is_staff" label-cols-md="4" label-for="is_staff">
                <b-form-checkbox
                id="is_staff"
...
export default {
  ...
  changeInput(){
    ...
    async createUser() {
      ...
      form.append("ill_history", this.user?.ill_history);
      form.append("finance_sum", this.user?.finance_sum);
      form.append("is_active", this.user?.is_active);
