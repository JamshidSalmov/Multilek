...
export default {
  ...
  methods: {
    ...
    async getCenterMapAddress(map) {
      this.center = map;
      this.$emit("getMapData", this.center);
      // let params =
      //   "lat=" +
      //   this.center.lat +
      //   "&lon=" +
  ...
  mounted() {
    this.$nextTick(() => {
      this.$refs.mapCreate.mapObject.dragging.enable();
      this.$refs.mapCreate.mapObject.touchZoom.enable();
      this.$refs.mapCreate.mapObject.doubleClickZoom.enable();
      this.$refs.mapCreate.mapObject.scrollWheelZoom.enable();
      this.$refs.mapCreate.mapObject.boxZoom.enable();
      this.$refs.mapCreate.mapObject.keyboard.enable();
    });
    // ("latlong", this.latlongg);
  },
};
</script>
